...
def build_keywords(filename):
    ...
    with open('usefuldata-711depart/keywords/机械制造行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_0:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/五金建材行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_1:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/农林牧渔行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_2:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/化工行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_3:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/电子通讯行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_4:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/文体生活用品行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_5:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/农副食品行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_6:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/纺织服饰行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_7:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/家电行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_8:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/其他行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_9:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/食品药品行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_10:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/交通运输行业.txt', 'w', encoding='utf-8') as f:
        for word in sorted_words_class_11:
            f.write(word)
            f.write('\n')
    with open('usefuldata-711depart/keywords/酒水饮料茶奶行业.txt', 'w', encoding='utf-8') as f:
