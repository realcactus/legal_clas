...
def train():
    ...
    x_train, y_train = data_loader.process_file(train_dir, word_to_id, cat_to_id, config.seq_length)
    x_val, y_val = data_loader.process_file(val_dir, word_to_id, cat_to_id, config.seq_length)
    x_test, y_test = data_loader.process_file(test_dir, word_to_id, cat_to_id, config.seq_length)
    ...
    for epoch in range(config.num_epochs):
        print('Epoch:', epoch + 1)
        batch_train = data_loader.batch_iter(x_train, y_train, config.batch_size)
